...
- Provenance and reproduction: `resources/market-plugin/VENDORED.md` — the Host half is an unmodified upstream copy, the Client half is an original redesigned UI under MIT.
