  ...
  factory: (require) => {
    ...
    function mountProjectColumn() {
      ...
      const attach = () => {
        ...
        column = document.createElement('div'); column.dataset.dppPreviewColumn = ''; column.style.cssText = 'min-width:0;overflow:hidden;display:flex;flex-direction:column;border-left:1px solid var(--dsw-alias-border-l2)'; frame.appendChild(column); projectPanelColumn = column; window.dispatchEvent(new Event('dsh-desktop-project-column'));
